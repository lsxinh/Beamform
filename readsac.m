...
% Suivant le type des signaux la lecture s'effectue de manière differente
...
% on teste pour savoir dans quel ordre sont ordonnés les bytes
...
% pg tamp=fread(fidev,inf,'float');
dsac.trace=fread(fidev,inf,'float');
...
dsac.pointe=h1(2);
dsac.bt=h1(6);		% begin time (décalage du 1er échantillon)
dsac.evt0=h1(8);	% Temps origine de l'évènement / référence

dsac.tp1=h1(11);
dsac.tp2=h1(12);
dsac.tp3=h1(13);	% Temps des phases pointées (10 possibles en fait)
dsac.tp4=h1(14);
dsac.tp5=h1(15);


dsac.slat=h1(32);
dsac.slon=h1(33);	% Coordonnées de la station
dsac.salt=h1(34);

dsac.elat=h1(36);
dsac.elon=h1(37);	% Coordonnées de l'événement
dsac.edep=h1(39);
...
dsac.dist=h1(54);	% distance ev-sta en degrées
...
dsac.evname=rm_blanc(h3(9:24))';	% Nom de l'événement (region)

dsac.ktp1=rm_blanc(h3(49:56))';
dsac.ktp2=rm_blanc(h3(57:64))';
dsac.ktp3=rm_blanc(h3(65:72))';	% Identification des pointés h1(11:20)
