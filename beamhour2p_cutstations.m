...
ev=dir(['/Volumes/JFNexternaldrive/Seismic/CASCADIAresponse/Jan/TestDay/Event_2012_309*']); %list of Event directories
...
%CUT GRID
LonLref=-125.2; LonUref= -124;  LatLref= 40; LatUref= 40.8;  
...
%%   
    eval(['save  -v7.3 /Volumes/JFNexternaldrive/Seismic/CASCADIAresponse/Jan/TestDay/', ev(kk).name,'/processedbm_cutstations/LHZ.',num2str(iyr),'.', num2str(imonth) ' beam  frq I  imonth timestep Ntime Nfrq SL theta Ntheta'])
%%
end
