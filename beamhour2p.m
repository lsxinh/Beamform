...
%%   
    eval(['save  -v7.3 /Volumes/JFNexternaldrive/Seismic/CASCADIAresponse/Jan/TestDay/', ev(kk).name,'/processedbm/','LHZ.',num2str(iyr),'.', num2str(imonth) ' beam  frq I  imonth timestep Ntime Nfrq SL theta Ntheta'])
%%
end
